...
class GUI(object):
  ...
  def validate_input(self):
    ...
    if connections < 0 or connections > 999999999999999:
      raise Exception('Please specify a number of connections greater than 0 '
          'and less than or equal to 999999999999999.')
    ...
    if conn_rate < 0 or conn_rate > 50000:
      raise Exception('Please specify a connection rate greater than 0 '
          'and less than or equal to 50000 '
            ' Higher than 10000 is experimental.')
